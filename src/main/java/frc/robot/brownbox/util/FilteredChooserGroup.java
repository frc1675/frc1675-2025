...
public class FilteredChooserGroup {
    ...
    private ShuffleboardTab
            tab; // We should use a more generic networktables solution here once we pick one, (if it exists?)
    ...
    public FilteredChooserGroup(ShuffleboardTab tab, String name, int layers, String... strings) {
        ...
        // The warning here is OK, we control all things added to the array.
        // We use an array instead of an arraylist here because we lean on the fact that it ahs a fixed size.
